    ...
    <div class="container-fluid page-header banner-img">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                <h3 class="display-4 text-white text-uppercase">CONVOCATORIAS</h3>
                <div class="d-inline-flex text-white">
                    <p class="m-0 text-uppercase"><a class="text-white" href="/">INICIO</a></p>
                    <i class="fa fa-angle-double-right pt-1 px-3"></i>
                    <p class="m-0 text-uppercase">{{ tipo }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid booking mt-5 pb-5">
        <div class="container pb-5">
            <div class="bg-light shadow" style="padding: 30px;text-align: center;">
                        <h1 class="text-white">{{ Convocatorias.length }} Resultados</h1>
            </div>
        </div>
    </div>
    <!-- Booking End -->
            ...
            <div class="row">
                <div class="col-lg-8">
                  <div v-if="searchGet" class="row pb-3">     
                        ...
                        <div v-else class="col-md-6 mb-4 pb-2" v-for="(conv, id_conv) of searchValues"
                            :key="id_conv"
                            v-show="
                            ...
                            <div class="blog-item">
                                <div class="position-relative">
                                    <img class="img-fluid w-100" :src="url_api + '/Convocatorias/' + conv.con_foto_portada" alt="">
                                    <div class="blog-date">
                                        <h6 class="font-weight-bold mb-n1">{{ dia(conv.con_fecha_fin) }}</h6>
                                        <small class="text-white text-uppercase">{{ dmy(conv.con_fecha_fin) }}</small>
                                    </div>
                                </div>
                                <div class="bg-white p-4">
                                    <div class="d-flex mb-2">
                                        <a class="text-primary text-uppercase text-decoration-none" href="">{{ tipo }}</a>
                                        <span class="text-primary px-2">|</span>
                                        <a class="text-primary text-uppercase text-decoration-none" href="">{{ conv.con_titulo }}</a>
                                    </div>
                    ...
                    <div v-else class="row pb-3">     
                      <h3 v-if="Convocatorias.length == 0">
                            No se encontraron resultados.
                          </h3>
                        <div v-else class="col-md-6 mb-4 pb-2" v-for="(conv, id_conv) of Convocatorias"
                            :key="id_conv"
                            v-show="
                              (pag - 1) * NUM_RESULTS <= id_conv &&
                             pag * NUM_RESULTS > id_conv
                     ...
                     <div class="mb-5">
                        <div class="bg-white" style="padding: 30px;">
                            <div class="input-group">
                                <input type="text" class="form-control p-4" :placeholder="'Buscar ' + tipo.toLowerCase().slice(0, -1)"
                      v-model="search"
                      @keyup="buscar()">
