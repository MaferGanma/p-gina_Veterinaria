    ...
    <div class="container-fluid page-header banner-img">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                <h3 class="display-4 text-white text-uppercase">EVENTOS</h3>
    ...
    <div class="container-fluid booking mt-5 pb-5">
        <div class="container pb-5">
          <div class="bg-light shadow" style="padding: 30px;text-align: center;">
                        <h1 class="text-white">{{ Eventos.length }} Resultados</h1>
            </div>
        </div>
    </div>
<!-- Blog Start -->
            ...
            <div class="row">
                <div class="col-lg-8">
                  <div v-if="searchGet" class="row pb-3">     
                        ...
                        <div v-else class="col-md-6 mb-4 pb-2" v-for="(ev, id_ev) of searchValues"
                :key="id_ev">
                            <router-link
                  ...
                  @click="$store.commit('clickLink')"
                      >
                            <div class="blog-item">
                                <div class="position-relative">
                                    <img class="img-fluid w-100" :src="url_api + '/Eventos/' + ev.evento_imagen"
                    alt="img">
                                    <div class="blog-date">
                                        <h6 class="font-weight-bold mb-n1">{{ dia(ev.evento_fecha) }}</h6>
                                        <small class="text-white text-uppercase">{{mes(ev.evento_fecha) }}</small>
                                    </div>
                                </div>
                                <div class="bg-white p-4">
                                    <div class="d-flex mb-2">
                                        ...
                                        <a class="text-primary text-uppercase text-decoration-none" href=""> {{ ev.evento_titulo }}</a>
                                    </div>
                    ...
                    <div v-else class="row pb-3">     
                      <h3 v-if="Eventos.length == 0">
                            No se encontraron resultados.
                          </h3>
                        <div v-else class="col-md-6 mb-4 pb-2" v-for="(ev, id_ev) of Eventos"
              :key="id_ev"> <router-link
              :to="'/detalleEvento/' + ev.evento_id"
                      >
                            <div class="blog-item">
                                <div class="position-relative">
