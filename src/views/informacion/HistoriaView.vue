    ...
    <div class="container-fluid page-header banner-img">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                <h3 class="display-4 text-white text-uppercase">NUESTRA HÍSTORIA</h3>
            ...
            <div class="row">
                <div class="col-lg-6" style="min-height: 500px;">
                    <div class="position-relative h-100 animated fadeInLeft">
                        <img class="position-absolute w-100 h-100" src="assets/img/facultad-img.jpg" style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-6 pt-5 pb-lg-5 ">
                    <div class="about-text bg-white p-4 p-lg-5 my-lg-5 animated fadeInRight sombra-border">
                        <h6 class="text-primary text-uppercase" style="letter-spacing: 5px;">{{ Institucion.institucion_nombre }}</h6>
                        <p v-html="Institucion.institucion_historia"></p>                   
                    </div>
                </div>
            </div>
        </div>
